...
#     }
    ...
    @spec do_paginate(conn :: conn_or_socket_or_endpoint_or_uri_or_binary_or_nil, page :: Scrivener.Page.t, fun :: (... -> String.t), arguments :: list, options :: %{optional(atom) => any}) :: Phoenix.HTML.safe
